...
final class UriNormalizer
{
    ...
    /**
     * All letters within a percent-encoding triplet (e.g., "%3A") are case-insensitive, and should be ized.
     *
     * Example: http://example.org/a%c2%b1b → http://example.org/a%C2%B1b
     */
    public const IZE_PERCENT_ENCODING = 1;
    ...
    {
        if ($flags & self::IZE_PERCENT_ENCODING) {
            $uri = self::izePercentEncoding($uri);
        }
    ...
    private static function izePercentEncoding(UriInterface $uri): UriInterface
    {
        $regex = '/(?:%[A-Fa-f0-9]{2})++/';
